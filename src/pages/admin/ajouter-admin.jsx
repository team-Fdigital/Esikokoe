    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 md:px-0">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md text-center">
          <h2 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-red-700">Accès refusé</h2>
          <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4">Vous devez être connecté en tant qu'administrateur pour ajouter un nouvel admin.</p>
          <button onClick={() => navigate("/admin/login")}
            className="py-1.5 md:py-2 px-3 md:px-4 text-sm md:text-base bg-blue-600 text-white rounded hover:bg-blue-700">Se connecter</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 md:px-0">
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md">
        <h2 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-blue-700">Ajouter un administrateur</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          <div>
            <label className="block text-xs md:text-sm mb-1 font-medium">Nom</label>
          ...
          <div>
            <label className="block text-xs md:text-sm mb-1 font-medium">Email</label>
          ...
          <div>
            <label className="block text-xs md:text-sm mb-1 font-medium">Mot de passe</label>
