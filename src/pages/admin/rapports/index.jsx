...
export default function RapportsIndex() {
  return (
    <div className="space-y-4 md:space-y-6 px-4 md:px-0">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 md:mb-2">Rapports</h1>
        <p className="text-sm md:text-base text-gray-600">Consultez les analyses et statistiques</p>
      </div>
